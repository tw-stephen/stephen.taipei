export const translations = {
  zh: {
    ...
    hero: {
      ...
      subtitle: "系統架構師",
      description:
        "擁有 AI 平台、電商系統、金融交易與教育應用的跨領域開發背景。導入 Nx Monorepo 架構，落實多專案模組共享與長期維護，推動百種主題動態配置，並將複雜元件程式從千行精簡至 200 行。",
      viewWork: "專案作品",
      contactMe: "聯繫我",
    },
    ...
    about: {
      ...
      description1:
        "我熱衷於學習與跨領域整合，從設計背景轉向資訊管理，最終專注於前後端開發與系統架構。熟悉 Angular 與 Laravel，具備從前端框架到後端架構的完整開發經驗。",
      description2:
        "曾帶領 6 人團隊，透過 Git、Trello、Slack 等工具進行看板式專案管理，成功完成多項 WebApp 開發與上架，累積需求分析、系統規劃、協作與程式碼品質控管的實戰經驗。",
      description3:
        "在職場之外，曾創立街舞教室，並於街舞比賽中獲得全國冠軍及全球前 8 強成績。這些經歷培養了毅力、專注力與突破挑戰的決心，也延伸到我的工作態度中。",
      ...
      projects: [
        {
          ...
          desc: "AI 客製化功能平台",
          fullDesc:
            "提供 AI 對話與繪圖，以及由 AI 生成多項客製化圖表等功能。以 Laravel Swoole Octane 實踐 WebSocket Server，搭配 Angular 呈現即時通訊功能，提供 AI 繪圖並實踐線上手繪功能。串接 OpenAI API 實現 AI 版心智圖、流程圖、曼陀羅九宮格思考術。",
          tech: [
            "Angular PWA",
        ...
        },
        {
          ...
          desc: "股市盤感訓練系統",
          fullDesc:
            "提供股市歷史價位資料，訓練盤感及選股策略。透過快取和流程設計，優化低成本共享主機效能，實現高達 500 人同時在線記錄。",
        ...
        },
        {
          ...
          desc: "手指皮紋檢測平台",
          fullDesc:
            "為幼兒及家長們提供手指皮紋檢測及報表產出。包含學員管理、皮紋分析、報告生成等完整功能。",
    ...
    contact: {
      title: "聯繫我",
      subtitle:
        "無論您有任何問題、專案合作想法，或是想要討論最新的技術趨勢，歡迎隨時與我聯繫。",
      email: "Email",
      location: "地點",
      locationValue: "台北, 台灣",
      formName: "姓名",
    ...
    tools: {
      ...
      title: "開源工具集合",
      subtitle:
        "8000+ 免費工具，涵蓋 AI、遊戲、開發工具等多個領域，完全開源免費",
      cta: "探索更多開源專案",
      viewAll: "查看 GitHub",
      items: {
        "ai-local-tools": {
          title: "AI 本地工具",
          description:
            "1000+ AI 工具，完全在瀏覽器本地執行，零後端、100% 隱私保護",
          count: "1000+ 工具",
        },
        "chrome-extensions": {
          title: "Chrome 擴充套件",
  ...
  en: {
    ...
    experience: {
      ...
      jobs: [
        {
          company: "____ Technology Co., Ltd.",
    ...
    tools: {
      ...
      subtitle:
        "8000+ free tools covering AI, games, development tools, and more - completely open source",
      ...
      items: {
        "ai-local-tools": {
          ...
          description:
            "1000+ AI tools running entirely in browser, zero backend, 100% privacy protected",
          count: "1000+ Tools",
        },
        "chrome-extensions": {
          title: "Chrome Extensions",
          description:
            "Curated Chrome browser extensions to boost productivity and browsing experience",
          count: "1000+ Extensions",
        },
        "free-games": {
          title: "Free Games",
          description:
            "Frontend web games, no download required, play instantly",
          count: "1000+ Games",
        },
        "mini-tools": {
          title: "Mini Tools",
          description:
            "Various utility tools including converters, calculators, and generators",
          count: "1000+ Tools",
        },
        "tailwind-ui": {
          title: "Tailwind UI Templates",
          description:
            "Beautiful Tailwind CSS UI components and page templates",
          count: "1000+ Templates",
        },
        "wasm-tools": {
          title: "WebAssembly Tools",
          description:
            "High-performance tools built with WebAssembly technology",
          count: "1000+ Tools",
        },
        "web-toys": {
          title: "Web Toys",
          description:
            "Fun interactive web experiences including animations and visual effects",
          count: "1000+ Toys",
        },
        "web-workers": {
          title: "Web Workers Examples",
          description:
            "Multi-threading examples to boost web application performance",
          count: "1000+ Examples",
        },
      },
    },
